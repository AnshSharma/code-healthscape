...
# st.sidebar.info('Developed by Ansh Sharma')
...
if nav == 'Database Library':
    ...
    df2 = df2.to_frame()
    df3 = df2.reset_index()
    figh = px.histogram(df3, x=s, nbins=20, template='none', marginal='rug', color_discrete_sequence=px.colors.sequential.RdBu,
                    labels={
                         "index": xT
                     },
